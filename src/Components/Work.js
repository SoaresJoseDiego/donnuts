...
const Work = () => {
  const workInfoData = [
    ...
    },
    {
      ...
      text: "Escolhemos a dedos os melhores ingredientes para garantir que nossos donuts sejam sempre frescos e deliciosos. Usamos apenas produtos de alta qualidade, desde a farinha até os recheios, para proporcionar a você uma experiência gustativa excepcional",
    },
    {
      image: <FontAwesomeIcon icon={faTruck} />,
      title: "Entrega em toda Cidade",
      text: "Levamos nossos donuts diretamente até você, em qualquer lugar da cidade. Nossa equipe de entregas garante que seu pedido chegue rápido e em perfeitas condições, para que você possa desfrutar de nossos donuts fresquinhos e sabororosos, onde quer que esteja.",
    },
  ];
  return (
    <div className="work-section-wrapper">
      <div className="work-section-top">
        ...
        <p className="primary-text">
          Nossa missão é proprociuonar a você uma experiência única e deliciosa.
          Desde a seleção cuidadosa dos ingredientes até a entrega no seu
          endereço, cada erpa do nosso processo é pensada para garantir que você
